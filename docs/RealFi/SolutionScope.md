...
* [The Interface](https://docs.google.com/presentation/d/1qcV-4WaIjiDc4AjFpXdcFWR1E1SYqOtCL63GvvJv8zI) describes business needs for RealFi to drive desired outcomes.
* [WorkplaceDAO](https://github.com/ChangePool/WorkplaceDAO) discusses a solution approach suitable for meeting RealFi business needs to create an interface between the Business and Ecosystem layers.
