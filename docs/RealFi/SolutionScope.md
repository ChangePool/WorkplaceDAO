...
* [WorkplaceDAO](https://github.com/ChangePool/WorkplaceDAO) discusses a solution approach suitable for meeting RealFi business needs to create an interface the Business and Ecosystem layers.
