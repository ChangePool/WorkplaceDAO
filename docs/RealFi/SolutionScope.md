...
* A legal separation exists between RealFi and the DAO. RealFi DAO SPOs are **not** employees. At times, the SPO community may also be able to act where core entities are constrained.
