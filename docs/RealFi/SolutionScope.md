...
Establishing a RealFi DAO for SPOs participating in the Accelerator Program supports high-level company goals by increasing social network density to improve interconnection, quality of information, trust and cohesion within RealFi and Cardano networks:<sup><a href="#Density">1</a></sup>
...
* Encouraging cooperative behaviour that RealFi, Cardano and Web3 need in order to succeed
